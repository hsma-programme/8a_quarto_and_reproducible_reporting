...
```{python}
#| output: asis
print(f"# {team} Community Mental Health Team")
```
...
def get_kpi_month(kpi):
  return f"Value for {most_recent_month_string}: {kpi_most_recent[kpi_most_recent['variable'] == kpi]['Formatted Value'].iloc[0]}"
